...
<div class="alert alert-info">
	当前位置<b class="tip"></b>Banner列表
</div>
<form id="searchForm" action="queryCBannerList">
	<table class="table table-striped table-bordered table-condensed">
		...
		<tbody>
			<tr>
				<td>Banner名称</td>
				<td class="detail"><input id="bannerName" name="bannerName"
					type="text" value="${model.bannerName }" />
				</td>
			...
			<tr>
				<td colspan="6" align="right"><input class="btn btn-inverse"
					...
					onclick="goUrl('addCBannerIndex')" value="添加" />&nbsp;</td>
			</tr>
		</tbody>
	</table>
</form>
...
<table class="table table-striped table-bordered table-condensed"
	...
	<thead>
		<tr class="tr_detail">
			...
			<td class="auto-style1">Banner名称</td>
		...
		<c:forEach items="${pageBean}" var="bean" varStatus="st">
			<tr>
				...
				<td><input class="btn btn-inverse" type="button" value="修改"
					onclick="goUrl('updateCBannerIndex?id=${bean.id}');" />&nbsp; <input
					class="btn btn-inverse" type="button" value="查看"
					onclick="goUrl('queryCBannerIndex?id=${bean.id}');" />&nbsp;</td>
			</tr>
