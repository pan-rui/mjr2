...
<div class="alert alert-info">
	当前位置<b class="tip"></b>添加问题
</div>
<form id="editForm" action="addCHelp">
	<table class="table table-striped table-bordered table-condensed list">
		...
		<tbody>
			<tr>
				<td>问题<font color="FF0000">*</font></td>
				<td><input name="questionName" value="" type="text"
					datatype="s2-80" nullmsg="请输入问题" errorMsg="问题长度为2-80位" /></td>
				<td>帮助类型<font color="FF0000">*</font></td>
			...
			<tr>
				<td>回答<font color="FF0000">*</font></td>
				<td colspan="3"><textarea rows="3" id="answer" name="answer"
						cols="100" style="width: 80%" datatype="*" nullmsg="请输入回答"></textarea>
		...
		<tfoot>
			<tr>
				<td colspan="4"><input class="btn btn-inverse" id="btnSave"
					...
					onclick="goUrl('queryCHelpList')" value="返回" />&nbsp;&nbsp;<span
