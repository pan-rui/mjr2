...
<div class="alert alert-info">
	当前位置<b class="tip"></b>添加媒体报道
</div>
<form id="editForm" action="addCMediaReport">
	<table class="table table-striped table-bordered table-condensed list">
		...
		<tbody>
			...
			<tr>
				...
				<td><input name="src" value="" type="text" datatype="s1-20"
					nullmsg="请输入来源名称" errorMsg="来源名称长度为1-20位" /></td>
				<td>来源URL<font color="FF0000">*</font>
				</td>
				<td><input name="srcUrl" value="" type="text"
			...
			<tr>
				...
				<td colspan="3"><textarea rows="3" id="content" name="content"
						cols="100" style="width: 80%" datatype="*" nullmsg="请输入内容"></textarea>
			...
			<tr>
				...
				<td><input name="srcImgPath" value="" type="text"
		...
		<tfoot>
			<tr>
				<td colspan="4"><input class="btn btn-inverse" id="btnSave"
					...
					onclick="goUrl('queryCMediaReportList')" value="返回" />&nbsp;&nbsp;<span
