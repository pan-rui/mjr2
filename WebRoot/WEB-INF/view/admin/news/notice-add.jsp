...
<div class="alert alert-info">
	当前位置<b class="tip"></b>添加公告
</div>
<form id="editForm" action="addCNotice">
	<table class="table table-striped table-bordered table-condensed list">
		...
		<tbody>
			<tr>
				...
				<td><input name="noticeTitle" value="" type="text"
		...
		<tfoot>
			<tr>
				<td colspan="4"><input class="btn btn-inverse" id="btnSave"
					...
					onclick="goUrl('queryCNoticeList')" value="返回" />&nbsp;&nbsp;<span
