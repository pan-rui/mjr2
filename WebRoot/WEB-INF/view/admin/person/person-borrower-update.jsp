	...
	<table class="table table-striped table-bordered table-condensed list">
		...
		<tbody>
			<tr>
				...
				<td><input id="borrowerIdCard" name="borrowerIdCard"  value="${tPersonBorrowerModel.borrowerIdCard }" type="text"
					datatype="idcard" nullmsg="请填写借款人身份证" errorMsg="借款人身份证格式不正确"/></td>
				<td>借款人手机号<font color="FF0000">*</font>
				</td>
				<td><input id="borrowerCellPhone" name="borrowerCellPhone"  value="${tPersonBorrowerModel.borrowerCellPhone }" type="text"
			...
			<tr>
				...
				<td><input name="houseStatus" type="radio" value="2" checked="checked" />未知&nbsp;<input name="carStatus" type="radio" value="0"/>否&nbsp;<input name="carStatus" type="radio" value="1"/>是</td>
			</tr>
			<tr>
				...
				<select id="monthlyIncomeLevel" name="monthlyIncomeLevel"  datatype="*"  ignore="ignore" nullmsg="请选择工作省份">
						<option value="">--请选择--</option>
