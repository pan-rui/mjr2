	...
	<table class="table table-striped table-bordered table-condensed list">
		...
		<tbody>
			<tr>
				...
				<td><input name="paraName" value="" type="text"
					datatype="s2-20" nullmsg="请输入参数名称" errorMsg="参数名称长度为2-20位" />
				</td>
				<td>参数编码<font color="FF0000">*</font>
				</td>
				<td><input name="paraCode" value="" type="text"
					datatype="s2-20" nullmsg="请输入参数编码" errorMsg="参数编码长度为2-20位" /></td>

			</tr>
			<tr>
				<td>参数键<font color="FF0000">*</font>
				</td>
				<td><input name="paraKey" value="" type="text" datatype="*1-20"
					nullmsg="请输入参数键" errorMsg="参数键长度为1-20位" /></td>
				<td>参数值<font color="FF0000">*</font>
				</td>
				<td><input name="paraValue" value="" type="text"
					datatype="*1-30" nullmsg="请输入参数值" errorMsg="参数值长度为1-30位" />
				</td>
			</tr>
			<tr>
		...
		<tfoot>
			<tr>
				<td colspan="4"><input class="btn btn-inverse" id="btnSave"
					...
					onclick="goUrl('queryBParaList')" value="返回" />&nbsp;&nbsp;<span
