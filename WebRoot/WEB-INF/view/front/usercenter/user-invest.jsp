...
<link rel="stylesheet" href="css/page.css" type="text/css" />
 <link type="text/css" href="css/jquery-ui-1.8.17.custom.css" rel="stylesheet" />
    ...
    <link type="text/css" href="js/My97DatePicker/skin/default/datepicker.css">
              ...
              <div class="invest">
                  ...
                  <div class="invest_tab">
                      <div class="invest_tit">
                          <a href="center/selectInvestList.html" class="it_tit it_ahover">投标中的借款</a>
                          <a href="center/selectInvestListforhsz.html" class="it_tit">回收中的借款</a>
                      ...
                      <div class="tz_inv" style="display:block;">
                          <!--搜索 start-->
                   <form id="searchForm" action="center/selectInvestList.html">
 							<input id="curPage" name="curPage" type="hidden" value="1" />
                          <div class="i_serch">
                              <span class="is_stit">时间：</span>
                              <%--<input type="text" name="investTimeup" class="is_stext" />
                          ...
                          <div class="pinv_tit">                                                   
                             ...
                             <span class="puinv_p puinv_p6">投标金额</span>
                             <span class="puinv_p puinv_p7">年华率</span>
                             <span class="puinv_p puinv_p8">期限</span>
                          ...
                          <c:forEach items="${pageBean}" var="bean" varStatus="st">
                              ...
                              <div class="pinv_box">
                                  ...
                                  <div class="pinv_b pinv_b6">${bean.realAmount }</div>
                                  <div class="pinv_b pinv_b7">${bean.annualRate }%</div>
                                  <div class="pinv_b pinv_b8">${bean.deadline }
                                  <c:choose>
