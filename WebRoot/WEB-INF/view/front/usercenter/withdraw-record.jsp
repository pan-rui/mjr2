      ...
      <div class="u_main">
          ...
          <div class="u_txt">
              ...
              <div class="m_user">
                  ...
                  <div class="tab_cont">
                      <div class="tabtit">
                         <a href="center/selectRcgRcdList.html" class="ctab_a ">充值记录</a>
                         <a href="center/selectWithdraw.html" class="ctab_a ctab_ahover">提现记录</a>
                      </div>
                      <!--提现记录--><!--这是提现记录选项卡内容-->
                      <div class="tabtxt" style="display:block;">
                      <form id="searchForm" action="center/selectWithdraw.html">
                          ...
                          <div class="tabm_tit">                                                                      
                              ...
                              <span class="tabm_t tabm_t2">提现时间</span>
                              
                              <span class="tabm_t tabm_t4">提现金额（元）</span>
                          ...
                          <div class="tabm_txt">
                             ...
                             <c:forEach items="${pageBean}" var="bean" varStatus="st">
                              <div class="tabm_box">
                                  <div class="m_btit m_btit1">1</div>
                                  <div class="m_btit m_btit2"><fmt:formatDate value="${bean.createTime }" pattern="yyyy-MM-dd HH:mm:ss"/></div>
                                  
                                  <div class="m_btit m_btit4">${bean.withdrawAmount }</div>
                                  <div class="m_btit m_btit5"><c:choose>
						<c:when test="${bean.withdrawStatus ==1}">申请中</c:when>
						<c:when test="${bean.withdrawStatus ==2}"><span class="m_state m_sok">转账中</span></c:when>
						<c:when test="${bean.withdrawStatus ==3}">提现成功</c:when>
						<c:when test="${bean.withdrawStatus ==4}">提现失败</c:when>
					</c:choose></div>
                              </div>
                              </c:forEach>
                              <!--box end-->
